...
const (
	...
	TaskTypeQuery
	// TaskTypeWorkflowStep is a TaskType of type WorkflowStep
	TaskTypeWorkflowStep
)

const _TaskTypeName = "DeployUnDeployScaleOutScaleInPurgeCustomCommandCustomWorkflowQueryWorkflowStep"
