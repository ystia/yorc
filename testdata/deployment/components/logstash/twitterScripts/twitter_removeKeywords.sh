...
log info "Update Twitter keywords property by removing value(s) in the array: "
...
remove_values_in_array_property $LOGSTASH_HOME/conf/1-${NODE}_logstash_inputs.conf "keywords" "${keywords}" || error_exit "Reconfiguration failed"
