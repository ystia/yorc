...
func TestTypes(t *testing.T) {
	...
	testVals := []struct {
		...
		val         interface{}
		expected    interface{}
		testGet     func(*testing.T, *fileStore, string, interface{})
	}{
		{"bool", boolVar, boolVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(bool)
			found, err := store.Get(key, actualPtr)
		...
		{"float", floatVar, floatVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
		...
		{"int", intVar, intVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(int)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"rune", runeVar, runeVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(rune)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"string", stringVar, stringVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
		...
		{"struct", structVar, structVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(Foo)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"struct with private field", structWithPrivateFieldVar, structWithPrivateFieldExpectedVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(Foo)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"private struct", privateStructVar, privateStructVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
		...
		{"private struct with private field", privateStructWithPrivateFieldVar, privateStructWithPrivateFieldExpectedVar, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new(privateFoo)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of bool", sliceOfBool, sliceOfBool, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]bool)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of byte", sliceOfByte, sliceOfByte, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]byte)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of int", sliceOfInt, sliceOfInt, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]int)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of string", sliceOfString, sliceOfString, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]string)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of slice of string", sliceOfSliceOfString, sliceOfSliceOfString, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([][]string)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of struct", sliceOfStruct, sliceOfStruct, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]Foo)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
		...
		{"slice of private struct", sliceOfPrivateStruct, sliceOfPrivateStruct, func(t *testing.T, store *fileStore, key string, expected interface{}) {
			actualPtr := new([]privateFoo)
			found, err := store.Get(key, actualPtr)
			handleGetError(t, err, found)
			actual := *actualPtr
