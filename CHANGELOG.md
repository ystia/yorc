...
When no location was defined yet, Yorc server will read this configuration file at startup and define the corresponding locations. Once this is done, this file won't be used anymore. Next version of Yorc will provide CLI and APIs allowing to create/update/delete locations.
