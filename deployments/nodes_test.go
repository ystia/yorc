...
func TestDeploymentNodes(t *testing.T) {
	...
	srv1.PopulateKV(map[string][]byte{
		...
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/tosca.nodes.Compute/name":                  []byte("tosca.nodes.Compute"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/tosca.nodes.Compute/attributes/id/default": []byte("DefaultComputeTypeid"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/tosca.nodes.Compute/attributes/ip/default": []byte(""),

		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC1/derived_from": []byte("tosca.nodes.SoftwareComponent"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC1/name":         []byte("janus.type.DerivedSC1"),

		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC2/derived_from":            []byte("tosca.nodes.SoftwareComponent"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC2/name":                    []byte("janus.type.DerivedSC2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC2/attributes/dsc2/default": []byte("janus.type.DerivedSC2"),

		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC3/derived_from": []byte("janus.type.DerivedSC2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC3/name":         []byte("janus.type.DerivedSC3"),

		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC4/derived_from":            []byte("janus.type.DerivedSC3"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC4/name":                    []byte("janus.type.DerivedSC4"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/types/janus.type.DerivedSC4/attributes/dsc4/default": []byte("janus.type.DerivedSC4"),
		...
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/0/relationship": []byte("tosca.relationships.Root"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/0/name":         []byte("req1"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/1/relationship": []byte("tosca.relationships.Root"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/1/name":         []byte("req2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/2/relationship": []byte("janus.type.1"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/2/node":         []byte("Node2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/2/name":         []byte("req3"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/3/relationship": []byte("tosca.relationships.Root"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node1/requirements/3/name":         []byte("req4"),
		...
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node2/requirements/0/relationship": []byte("tosca.relationships.Root"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node2/requirements/0/name":         []byte("req1"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node2/requirements/1/relationship": []byte("tosca.relationships.HostedOn"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node2/requirements/1/node":         []byte("Compute1"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node2/requirements/1/name":         []byte("req2"),
		...
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node3/requirements/0/relationship": []byte("janus.type.3"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node3/requirements/0/node":         []byte("Compute2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node3/requirements/0/name":         []byte("req1"),
		...
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node4/requirements/0/relationship": []byte("tosca.relationships.HostedOn"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node4/requirements/0/node":         []byte("Node2"),
		DeploymentKVPrefix + "/testGetNbInstancesForNode/topology/nodes/Node4/requirements/0/name":         []byte("host"),
