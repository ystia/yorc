...
GOTOOLS = github.com/abice/go-enum github.com/google/addlicense github.com/ystia/tdt2go/cmd/tdt2go
...
# -count is for disabling test cache
	@./build/bin/gotestsum --jsonfile tests-reports.json  -- -tags "testing $(BUILD_TAGS)" $(TESTARGS) -count=1 -p 1 ./...
