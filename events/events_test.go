...
//
//	require.Equal(t, StatusChangeTypeInstance.String(), events[0].Type)
...
//
//	require.Equal(t, StatusChangeTypeDeployment.String(), events[1].Type)
...
//
//	require.Equal(t, StatusChangeTypeScaling.String(), events[2].Type)
...
//
//	require.Equal(t, StatusChangeTypeCustomCommand.String(), events[3].Type)
...
//
//	require.Equal(t, StatusChangeTypeWorkflow.String(), events[4].Type)
