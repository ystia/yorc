...
.. code-block:: bash
    ...
    wget https://releases.hashicorp.com/terraform-provider-google/2.0.0/terraform-provider-google_2.0.0_linux_amd64.zip
    sudo unzip terraform-provider-google_2.0.0_linux_amd64.zip -d /var/terraform/plugins
