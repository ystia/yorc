...
type mockActivity struct {
	t dispatcher.ActivityType
	v string
}

func (m *mockActivity) Type() dispatcher.ActivityType {
	return m.t
}
...
func testPostComputeCreationHook(t *testing.T, kv *api.KV, cfg config.Configuration) {
	...
	type args struct {
		...
		activityType dispatcher.ActivityType
		endpointIPs  []string
	...
	tests := []struct {
		...
		{"TestEndpointFromPublicIP", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeDelegate, nil, []map[string]string{
		...
		{"TestEndpointFromPublicAddr", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeCallOperation, nil, []map[string]string{
		...
		{"TestEndpointFromPrivateAdd", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeDelegate, nil, []map[string]string{
		...
		{"TestEndpointFromIPAdd", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeCallOperation, nil, []map[string]string{
		...
		{"TestEndpointAlreadySet", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeDelegate, []string{"10.1.0.4", "10.1.1.4", "10.1.2.4", "10.1.3.4", "10.1.4.4"}, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointTaskFailed", args{tasks.TaskStatusFAILED, dispatcher.ActivityTypeDelegate, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointTaskCancelled", args{tasks.TaskStatusCANCELED, dispatcher.ActivityTypeDelegate, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointInlineActivity", args{tasks.TaskStatusRUNNING, dispatcher.ActivityTypeInline, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
