...
func testPostComputeCreationHook(t *testing.T, kv *api.KV, cfg config.Configuration) {
	...
	target := "Compute"
	type args struct {
		taskStatus   tasks_old.TaskStatus
	...
	tests := []struct {
		...
		{"TestEndpointFromPublicIP", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeDelegate, nil, []map[string]string{
		...
		{"TestEndpointFromPublicAddr", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeCallOperation, nil, []map[string]string{
		...
		{"TestEndpointFromPrivateAdd", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeDelegate, nil, []map[string]string{
		...
		{"TestEndpointFromIPAdd", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeCallOperation, nil, []map[string]string{
		...
		{"TestEndpointAlreadySet", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeDelegate, []string{"10.1.0.4", "10.1.1.4", "10.1.2.4", "10.1.3.4", "10.1.4.4"}, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointTaskFailed", args{tasks_old.TaskStatusFAILED, workflow.ActivityTypeDelegate, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointTaskCancelled", args{tasks_old.TaskStatusCANCELED, workflow.ActivityTypeDelegate, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
		...
		{"TestEndpointInlineActivity", args{tasks_old.TaskStatusRUNNING, workflow.ActivityTypeInline, nil, []map[string]string{
			map[string]string{"ip_address": "10.0.0.4"},
			map[string]string{"ip_address": "10.0.1.4"},
			map[string]string{"ip_address": "10.0.2.4"},
			map[string]string{"ip_address": "10.0.3.4"},
